...
"""
import time, os, zipfile, sys, textwrap, threads_new, itertools, shutil, functools
import subprocess
...
class DownloaderGUI(object):
    ...
    def __init__(self, dataserver, use_threads=True):
        ...
        self._download_lock = threads_new.Lock()
    ...
    class _DownloadThread(threads_new.Thread):
        def __init__(self, data_server, items, lock, message_queue, abort):
            ...
            self.abort = abort
            threads_new.Thread.__init__(self)
