...
class TransferCoordinator(object):
    ...
    def __init__(self, transfer_id=None):
        ...
        self._done_event = threads_new.Event()
        self._lock = threads_new.Lock()
        self._associated_futures_lock = threads_new.Lock()
        self._done_callbacks_lock = threads_new.Lock()
        self._failure_cleanups_lock = threads_new.Lock()
