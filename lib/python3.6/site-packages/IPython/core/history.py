...
class HistoryManager(HistoryAccessor):
    ...
    save_thread = Instance('IPython.core.history.HistorySavingThread',
                           allow_none=True)
    save_flag = Instance(threads_new.Event, allow_none=True)
    ...
    def __init__(self, shell=None, config=None, **traits):
        ...
        super(HistoryManager, self).__init__(shell=shell, config=config,
            **traits)
        self.save_flag = threads_new.Event()
        self.db_input_cache_lock = threads_new.Lock()
        self.db_output_cache_lock = threads_new.Lock()
...
class HistorySavingThread(threads_new.Thread):
